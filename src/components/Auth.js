    ...
    <div className="max-w-md mx-auto mt-20">
      <div className="bg-dark-card rounded-lg shadow-xl p-8">
        ...
        <form onSubmit={handleAuth} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-primary hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg transition duration-200"
          >
            {isLogin ? 'Login' : 'Sign Up'}
          </button>
        </form>
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full bg-white text-gray-800 font-bold py-2 px-4 rounded-lg hover:bg-gray-100 transition duration-200 flex items-center justify-center"
          >
